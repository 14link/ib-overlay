...
#第三方插件 luci-app-daede
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-daede kmod-sched-core kmod-sched-bpf kmod-veth kmod-xdp-sockets-diag curl nano"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-daede kmod-sched-core kmod-sched-bpf kmod-veth vmlinux-btf curl"
